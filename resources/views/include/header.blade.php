...
<head>
    ...
    <link rel="stylesheet" href="{{asset('public/assets/compiled/css/ui-widgets-chatbox.css')}}">
    <link rel="stylesheet" href="{{asset('public/assets/compiled/css/application-email.css')}}">
        ...
        <div id="main" class="layout-horizontal">
            <header class="mb-5">
                <div class="header-top">
                    <div class="container">
                        <div class="logo">
                            <a href="./"><img src="{{asset('public/assets/compiled/svg/logo.svg')}}" alt="Logo"></a>
                        </div>
                            ...
                            <div class="dropdown">
                                ...
                                <a href="#" id="topbarUserDropdown" class="user-dropdown d-flex align-items-center dropend dropdown-toggle " data-bs-toggle="dropdown" aria-expanded="false">
                                    <div class="avatar avatar-md2" >
                                        <img src="{{asset('public/assets/compiled/png/avatar.png')}}" alt="Avatar">
                                    </div>
                                    <div class="text">
                    ...
                    <div class="container">
                        <ul>
                            ...
                            @if(isset(auth()->user()->id))
                                        ...
                                        <div class="submenu-group-wrapper">
                                            <ul class="submenu-group">
                                                <li class="submenu-item  ">
                                                    <a href="{{asset('club-list')}}" class="submenu-link">Club List</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                ...
                                <li class="menu-item  has-sub">
                                    <a href="#" class="menu-link">
                                        <span><i class="bi bi-file-earmark-medical-fill"></i> Member </span>
                                    </a>
                                    <div class="submenu ">
                                        <!-- Wrap to submenu-group-wrapper if you want 3-level submenu. Otherwise remove it. -->
                                        <div class="submenu-group-wrapper">
                                            <ul class="submenu-group">
                                                <li class="submenu-item  ">
                                                    <a href="{{asset('member-list')}}" class="submenu-link">Member List</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
